...
*/
$config['logo'] = 'assets/image/header.jpg';
...
| Main page's Title
*/
$config['head_title'] = 'MINISTERIO DE SALUD PÚBLICA Y ASISTENCIA SOCIAL GUATEMALA';
...
| Main page's Subitle
*/
$config['head_subtitle'] = 'HOSPITAL REGIONAL DE OCCIDENTE QUETZALTENANGO';

$config['head_subtitle_2'] = 'BONO ACADEMICO 416 MES DE';
