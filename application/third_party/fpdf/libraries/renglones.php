...
class renglones extends FPDF
{
    ...
    function __construct()
    {
        ...
        $this->head_subtitle_2        =   $this->format($ci->config->item('head_subtitle_2'));
    ...
    **/
    function header()
    {
        $this->Image($this->logo,10,10,64);
        $this->SetFont( 'Arial' , 'B' ,10 );
        $this->Cell(70);

        $this->Cell(120,5,$this->head_title,0,0,'L');
        $this->Ln('5');
        $this->Cell(70);

        $this->SetFont('Arial','',10);
        $this->Cell(120,5,$this->head_subtitle,0,0,'L');
        $this->Ln('5');
        $this->Cell(70);

        $this->Cell(120,5,$this->head_subtitle_2,0,0,'L');
        $this->Ln(15);
    }
    ...
    **/
    function render($dest='I',$name='nomina.pdf')
    {
